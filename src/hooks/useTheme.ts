...
) => isThemeName(nextThemeName)
        ? getTheme(nextThemeName)
        : theme

export const useTheme = (intialTheme: ThemeName): [ThemeEntity, (nextTheme: string) => void] => useReducer(themeReducer, getTheme(intialTheme))